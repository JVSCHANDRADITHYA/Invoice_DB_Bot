...
bulk_confirm = input("Generate invoices for all projects of the resource or all resources? (project/resource/none): ").strip().lower()
if bulk_confirm == "yes":
    all_files = inv.all_resources_invoice(financial_period  = "2025-11")
    for f in all_files:
        print(f)
